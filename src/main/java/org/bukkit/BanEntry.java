...
public class BanEntry {
    ...
    private String target, reason, source;
    private Date createdAt, expiresAt;

    public BanEntry(String target, String reason, String source, Date createdAt, Date expiresAt) {
        this.target = target;
        this.reason = reason;
        this.source = source;
     ...
     */
    public void save() {
        throw new UnsupportedOperationException("Cannot save BanEntry directly!");
    }
}
