...
public class MemorySection implements ConfigurationSection {
    ...
    @Override
    @Nullable
    public org.bukkit.util.Vector getVector(@NotNull String path) {
        return getSerializable(path, org.bukkit.util.Vector.class);
    }

    @Override
    @Contract("_, !null -> !null")
    @Nullable
    public org.bukkit.util.Vector getVector(@NotNull String path, @Nullable org.bukkit.util.Vector def) {
        return getSerializable(path, org.bukkit.util.Vector.class, def);
    }
